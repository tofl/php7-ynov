...
<main role="main">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>Les séries qui sont suivies par le plus de monde.</p>
                <p>
                    <div class="card">
                        <img class="card-img-top" src="https://www.betaseries.com/images/fonds/banner/1161_1502049726.jpg">
                        <div class="card-body">
                            <h5 class="card-title">#1 - <a href="serie.php?serie=gameofthrones">Game of Thrones</a></h5>
    ...
    <p>
        <a class="btn btn-outline-secondary" href="classement.php?critere=popularite" role="button">
    ...
    <p>
        <a class="btn btn-outline-secondary" href="classement.php?critere=note" role="button">
            <i class="fa fa-trophy"></i> Voir tout le classement
        </a>
    </p>
    </div>
